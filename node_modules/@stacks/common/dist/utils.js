...
function intToBigInt(value, signed) {
    ...
    if (value instanceof Uint8Array || buffer_1.Buffer.isBuffer(value)) {
        if (signed) {
            const bn = new bn_js_1.default(value, 'be').fromTwos(value.byteLength * 8);
            return BigInt(bn.toString());
        }
        else {
            return BigInt(new bn_js_1.default(value, 'be').toString());
        }
    }
    if (value instanceof bn_js_1.default || bn_js_1.default.isBN(value)) {
